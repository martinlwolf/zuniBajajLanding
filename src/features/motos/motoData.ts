...
export const MOTO_DATA = {
    ...
    'boxer-ct-100': {
        ...
        model: 'Boxer',
        version: 'CT 100',
        images: ['https://i.ibb.co/xS61Qzt5/Boxer-CT100-Negro-Rojo.webp',
            'https://i.ibb.co/DD8HCvwP/Boxer-CT100-Negro-azul.webp',
            'https://i.ibb.co/jPtCtR3G/Boxer-CT100-Rojo.webp'
        ],
        ...
        specSections: [
            ...
            },
            {
                title: 'Motor y Rendimiento',
                items: [
                    { label: 'Cilindrada', value: '102 cc' },
                    { label: 'Motor', value: 'Monocilíndrico 4T, 2 valvulas' },
                    { label: 'Tanque', value: '10.4 L' },
                    { label: 'Combustible', value: 'Nafta' },
                    { label: 'Batería', value: '12V' },
